...
const ageGroups = [
  {
    ...
    illustration: "rocket",
    description: "Tap-and-play coding logic, colors, shapes & story play",
  },
  {
    range: "5–7",
    ageGroup: "AGES_5_7",
    ...
    illustration: "robot",
    description: "ScratchJr coding, sequencing & creative storytelling",
  },
  {
    range: "8–10",
    ageGroup: "AGES_8_10",
    ...
    illustration: "code",
    description: "Scratch, game design, animation & problem solving",
  },
  {
    range: "11–13",
    ageGroup: "AGES_11_13",
    ...
    illustration: "robot",
    description: "Python, web basics, AI for kids & virtual robotics",
  },
  {
    range: "14–16",
    ageGroup: "AGES_14_16",
    ...
    illustration: "atom",
    description: "Web & app dev, AI + prompt engineering, portfolios",
  },
  {
    range: "17–18",
    ageGroup: "AGES_17_18",
    label: "Future Tech Leader",
    gradient: "from-indigo-100 to-indigo-50",
    border: "border-indigo-200 hover:border-indigo-400",
    tagColor: "bg-indigo-100 text-indigo-700",
    illustration: "atom",
    description: "Advanced Python/AI, full-stack & entrepreneurship",
  },
];
